...
Current work is focused on implement security features that silo client connections into their own heaps, so a malicious attacker is not able to mount protocol level attacks to exhaust server resources. Next, packet fragmentation and reassembly will be implemented and libyojimbo 0.3 will be ready for release.
